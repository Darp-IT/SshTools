...
namespace SshTools.Tests.Unit.Parser
{
    public class ArgumentParserTests
    {
        ...
        public void Host_DeserializeAndSerialize(string argument, bool success = true) =>
            Test_DeserializeAndSerialize(ArgumentParser.Host, (HostNode v) => v.MatchString == argument, success, argument);
        ...
        public void Match_DeserializeAndSerialize(string argument, bool success = true) =>
            Test_DeserializeAndSerialize(ArgumentParser.Match, (MatchNode v) => v.MatchString == argument, success, argument);
